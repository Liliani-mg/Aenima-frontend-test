...
function Footer() {
  ...
  return (
    <footer class={isMobile?"d-flex flex-wrap justify-content-between align-items-center border-top bg-dark px-2 py-2 ":"d-flex flex-wrap justify-content-between align-items-center border-top bg-dark pt-4 p-5 "}>
